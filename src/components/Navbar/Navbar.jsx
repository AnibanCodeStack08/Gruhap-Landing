        ...
        <>
          ...
          <div className="navbar-mobile-dropdown">
            ...
            <div className="navbar-mobile-nav-actions">
              <button className="navbar-mobile-login-btn" onClick={closeMobileMenu}>Login</button>
              <button className="navbar-mobile-get-started-btn" onClick={closeMobileMenu}>Get Started</button>
            </div>
          </div>
        </>
      )}
